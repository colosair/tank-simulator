...
public class DAEJEON4_YOOSEUNGHO3 {
    private static String NICKNAME = "DAEJEON4_YOOSEUNGHO3";
...
class Node {
    ...
    public Node(int r, int c, ArrayList<String> path) {
        this.r = r;
        this.c = c;
        this.path = path;
    }
